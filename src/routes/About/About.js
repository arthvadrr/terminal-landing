...
BBBBBBBBBBBB###BBBBBBBBBBBBBBBBBBBBBBBBBBBB##BBBBBBBBBBBBBBBBBBBBBBBBBBBBBGBBBBBBB#BBBBBGBBBBBBBBBBB`}</pre>
    ...
    useEffect(() => {
      ...
      }, [aboutLoadingText, loadingTextArr])
    ...
    return (
        ...
        <div className="page-flex">
            ...
            <span className="about-inner">
                {asciiPortrait}
                <p>Hello there! My name is Bryan and I'm a proud Southern native hailing from the beautiful state of Tennessee. I'm a versatile and dedicated frontend developer.</p>
                <p> When I'm not immersed in the world of insanity, you'll likely find me enjoying the great outdoors on my bike, exploring scenic routes and challenging myself with new trails.</p>
                ...
                <p> A true Southern at heart, I can't resist the taste of a refreshing sweet tea after a long day, or anytime, really. especially while watching my favorite sport, hockey.</p>
