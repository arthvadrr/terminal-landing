    ...
    return (
        ...
        <div className="page-flex">
            ...
            <span className="about-inner">
                <p>
                    {asciiPortrait}
                Hello there! My name is Bryan and I'm a proud Southern native hailing from the beautiful state of Tennessee. I'm a versatile and dedicated frontend developer with a passion for creating elegant and functional websites using WordPress and PHP. </p>
